...
var shopArray = []; //list of objects generated by constructor. +2 prototypes
...
StoreSheet.prototype.render = function () {
  ...
  xtdElement = document.createElement('td');
  xtdElement.textContent = this.totalSales; //suspect
  xtrElement.appendChild(xtdElement);
...
//event listeners callback function vvv /////////////////////////////////////////////////////
function addNewShop(event) {
  ...
  for (var i in shopArray){
    console.log('redraw: avgsale ' + [i] + ' ' + shopArray[i].avgSale)
    console.log('redraw: mincust ' + [i] + ' ' + shopArray[i].minCust)
    console.log('redeaw: maxcust ' + [i] + ' ' + shopArray[i].maxCust)
  }
